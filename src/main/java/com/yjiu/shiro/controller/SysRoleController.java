...
public class SysRoleController {
	 ...
	 * 保存
	 * @param project
	 * @param layuiTreeCheck	layui树勾选后会上传此参数
	 * @return
	 */
	@RequestMapping("/sysrole/save")
	@ResponseBody
	public PTWResult save(SysRole project,String layuiTreeCheck) {
		try {
			project.setResourceIds(layuiTreeCheck);
	...
	@ResponseBody
	public PTWResult update(SysRole project,String layuiTreeCheck) {
		try {
			project.setResourceIds(layuiTreeCheck);
